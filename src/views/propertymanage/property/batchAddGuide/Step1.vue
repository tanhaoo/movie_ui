            ...
            <a-row>
                <a-col :span="12">
                    <a-form-item label="所属公司" :labelCol="labelCol" :wrapperCol="wrapperCol">
                        <a-select
                            @change="company"
                            v-decorator="['company',{ rules: [{ required: true, message: '所属公司必须填写', trigger: 'change' }]},]">
            ...
            <a-row>
                <a-col :span="12">
                    <a-form-item label="选择住宅" :labelCol="labelCol" :wrapperCol="wrapperCol">
                        <a-select
                            @change="estate"
                            v-decorator="['estate',{ rules: [{ required: true, message: '选择住宅必须填写', trigger: 'change' }],
                            initialValue: estateSelect[0]===undefined?'':estateSelect[0].estateName+'' },]">
                            <a-select-option :key="index" :value="item.estateCode+''"
                                             v-for="(item,index) in estateSelect">
                                {{ item.estateName }}
                            </a-select-option>
                        </a-select>
                    </a-form-item>
                ...
                <a-col :span="12">
                    <a-form-item label="新增楼宇数量" :labelCol="labelCol" :wrapperCol="wrapperCol">
                        <a-input
                            v-decorator="['addhomecount',{ rules: [{ required: true, message: '新增楼宇数量必须填写', trigger: 'blur' }] },]"/>
                    </a-form-item>
                </a-col>
            </a-row>
